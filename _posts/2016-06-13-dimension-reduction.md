...
In these situations the problem posed is
...
![swiss roll](/images/swissroll.gif) borrowed from [dinoj](http://people.cs.uchicago.edu/~dinoj/manifold/swissroll.html).
